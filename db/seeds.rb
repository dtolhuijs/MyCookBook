...
ramon = User.create( { name: "Ramon",  email: "ramon@test.nl", password: "aaaaaaaa", birthday:"1965-01-01", avatar: "profilemale.jpg", bio:"I LOVE food. I already experimented with different recipes when I was 8 years old. My Favorite cuisine is Italian food."})
deisi = User.create( { name: "Deisi",  email: "deisi@test.nl", password: "bbbbbbbb", birthday:"2000-03-01", avatar: "profilemale.jpg", bio:"I LOVE food. I already experimented with different recipes when I was 8 years old. My Favorite cuisine is Italian food."})
fiona = User.create( { name: "Fiona",  email: "fiona@test.nl", password: "cccccccc", birthday:"1985-01-01", avatar: "profilemale.jpg", bio:"I LOVE food. I already experimented with different recipes when I was 8 years old. My Favorite cuisine is Italian food."})
jake  = User.create( { name: "Jake",   email: "jake@test.nl",  password: "dddddddd", birthday:"1990-01-01", avatar: "profilemale.jpg", bio:"I LOVE food. I already experimented with different recipes when I was 8 years old. My Favorite cuisine is Italian food."})
